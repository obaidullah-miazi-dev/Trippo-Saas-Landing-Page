    ...
    >
      ...
      <Container className="relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1
            ref={titleRef}
            className="text-5xl md:text-7xl font-bold text-foreground mb-8 tracking-tight leading-tight opacity-0"
          >
          ...
          <p
            ref={subtitleRef}
            className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed opacity-0"
          >
            Trippo provides the infrastructure you need to scale your
            application without the headache. Focus on your code, we handle the
            rest.
          </p>
              ...
              <div className="rounded-lg overflow-hidden bg-card aspect-video relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center text-slate-700">
                  <div className="w-full h-full  p-8 grid grid-cols-12 gap-4">
                    {/* Sidebar */}
                    <div className="col-span-3 bg-slate-900 rounded-lg border  h-full overflow-hidden">
                        <img src="https://i.ibb.co.com/RpNhsq45/ai-generated-1768184408710.jpg" alt="" className="h-full object-center"/>
                    </div>
                    {/* Main Content */}
                    <div className="col-span-9 flex flex-col gap-4">
                      <div className="h-32 bg-slate-900 rounded-lg border  w-full overflow-hidden">
                        <img
                          src="https://i.ibb.co.com/zHQJXy8F/Gemini-Generated-Image-uv6fmxuv6fmxuv6f.png"
                          alt=""
                          className="h-32 w-full object-cover"
                        />
                      </div>
                      <div className="flex gap-4 h-full">
                        <div className="flex-1 bg-slate-900 rounded-lg border  overflow-hidden">
                          <img
                            src="https://i.ibb.co.com/1YhYmNKB/ai-generated-1768184319003.jpg"
                            alt=""
                        ...
                        <div className="flex-1 bg-slate-900 rounded-lg overflow-hidden">
                          <img
                            src="https://i.ibb.co.com/0RHxL7PH/ai-generated-1768184228647.jpg"
                            alt=""
